...
{
    [InitializeOnLoad]
    public class Q_ShootersMenu : IVRCSDKBuildRequestedCallback
    {
        public const string RootMenu = "Q-Shooters/";
        private const string MenuName = RootMenu + "Auto Setup";
        public static bool autoSetup = true;
        static Q_ShootersMenu()
        {
        ...
        {
            string sourceDir = "Packages/com.devopslazar.q-shooters/Samples~/Example";
        ...
        {
            Application.OpenURL("https://github.com/MMMaellon/Q-Shooters/wiki");
        }
        ...
        private static void NavigateToPrefabs()
        {
            ...
            var prefabFolder = AssetDatabase.LoadAssetAtPath("Packages/com.devopslazar.q-shooters/Runtime/Prefabs", typeof(Object));
        ...
        public static bool Setup()
        {
            ...
            foreach (Q_Shooter shooter in GameObject.FindObjectsOfType<Q_Shooter>())
            {
                Q_Shooter.SetupShooter(shooter);
            }
            ...
            Q_ShootersPlayerHandler.SetupPlayers();
