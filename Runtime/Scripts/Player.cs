...
namespace DevOpsLazar.Q_Shooters
{
    ...
    public class Player : Cyan.PlayerObjectPool.CyanPlayerObjectPoolObject
    {
        ...
        public void _print(string message)
        {
            ...
            {
                Debug.Log("<color=yellow>[Q-Shooters Player.cs] " + name + ": </color>" + message);
            }
        }
        ...
        public virtual void OnParticleCollision(GameObject other)
        {
            ...
            otherPShooter = other.GetComponent<Q_Shooter>();
            if (!Utilities.IsValid(otherPShooter))
            {
                otherPShooter = other.GetComponentInParent<Q_Shooter>();
            }
        ...
        public virtual void OnPShooterHit(Q_Shooter otherShooter)
        {
            ...
            if (!otherShooter.sync.IsLocalOwner() || otherShooter.state == Q_Shooter.STATE_DISABLED)
            {
                return;
            }
