...
namespace DevOpsLazar.Q_Shooters
{
    ...
    public class Helper
    {
        ...
        {
            Debug.LogErrorFormat(context, "<color=red>[Q-Shooters AutoSetup]: ERROR</color> {0}", message);
        }
        public static void InfoLog(Object context, string message)
        {
            Debug.LogFormat(context, "<color=blue>[Q-Shooters AutoSetup]: INFO</color> {0}", message);
        }
    } 
}
#endif