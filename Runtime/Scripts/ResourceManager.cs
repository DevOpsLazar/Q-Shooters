...
3) Set up your player object pool. Make sure there's one in your scene and it has the appropriate max player count and that it has a Q-ShootersPlayerHandler on it somewhere.
